            ...
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-10">
                  {FeatureImage.map((val,i) =>(
                    <div key={i} className="flex flex-cols items-center bg-white rounded-lg shadow-lg overflow-hidden transform-transition duration-300 hover:scale-105 hover:shadow-2xl">
              ...
              <div className="flex justify-between w-full px-4 py-2">
                <div className="flex flex-col items-start">
                  <h2 className="font-medium text-lg mb-1 text-gray-600">Library Stone Chair</h2>
