        ...
        <div className="">
            <footer className="text-gray-600 body-font">
                <div className="py-10 md:py-24">
                    <div className="flex flex-wrap md:flex-nowrap md:text-center justify-center">
                        ...
                        <a className="flex title-font font-medium items-center justify-center text-gray-900">
                            ...
                            <span className="ml-3 text-xl text-white">Comforty</span>
                            </a>
                        ...
                        <nav className="list-none mb-10">
                            ...
                            <li><a className="text-gray-600 hover:text-gray-800">Terms And Condition</a></li>
                        ...
                        <div className="flex flex-wrap justify-center items-end">
                            <div className="relative w-full sm:w-40 md:w-auto mb-3 md:mb-0">
                                <label htmlFor="Footer-field" className="leading-7 text-sm text-gray-500">PlaceHolder</label>
                                <input type="text"
                                id="Footer-field"
                                name="Footer-field"
                                className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:bg-transparent focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out "
                                 />
                            </div>
                            <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounder">
                              Button  
                            </button>
                        </div>
